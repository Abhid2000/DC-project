...
$view=mysqli_query($con, "select * from tbl_tender where id='$tender_id' ");
$view1=mysqli_query($con, "select * from tbl_tender where id='$tender_id' ");
...
$sql = "SELECT tbl_tender_details.*,tbl_tender.headings,tbl_tender.description FROM tbl_tender,tbl_tender_details WHERE tbl_tender_details.tender_id=$tender_id";
...
<!-- Mirrored from templates.envytheme.com/wikin/default/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 May 2022 12:21:32 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/fontawesome.min.css">
		...
		<!-- Title -->
		<?php $row = mysqli_fetch_array($view1);
                        // print_r($a);die();
                        ?>
		...
		<section class="project-details-area ptb-100">
			<div class="container">
				<div class="project-details-content">
                    ...
                    while($row = mysqli_fetch_assoc($res)) {?>
							<div class="col-lg-6 col-md-6">
								<div class="services-img">
									<img src="tender_images/<?php echo $row['tender_images']?>" alt="Image">
								</div>
							</div>
							<?php }?>
						</div>
                    ...
                    while($row = mysqli_fetch_assoc($res)) {?>
					<div class="services-content">
						<h3><?php echo $row['headingsd']?></h3>

						<p><?php echo $row['descriptiond']?></p>
					</div>
					<?php }?>
				</div>
			</div>
...
<!-- Mirrored from templates.envytheme.com/wikin/default/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 May 2022 12:21:40 GMT -->
</html>