...
if (isset($_POST['submit'])){
    ...
    $income = get_safe_value($con,$_POST['income']);
    $incomeyear = get_safe_value($con,$_POST['incomeyear']);
    $income_words = get_safe_value($con,$_POST['income_words']);
    $reason = get_safe_value($con,$_POST['reason']);
    $status = 'Pending';
	$added_on=date('y-m-d h:i:s');

	$photo = $_FILES['photo']['name'];
	$aadhaarpic = $_FILES['aadhaarpic']['name'];
	$ration_voting = $_FILES['ration_voting']['name'];
	$birth_school_pan = $_FILES['birth_school_pan']['name'];
	$frm16_tax_salary = $_FILES['frm16_tax_salary']['name'];

	$dir1 = "income/".$photo;
	$dir2 = "income/".$aadhaarpic;
	$dir3 = "income/".$ration_voting;
	$dir4 = "income/".$birth_school_pan;
	$dir5 = "income/".$frm16_tax_salary;

	move_uploaded_file($_FILES['photo']['tmp_name'], $dir1);
	move_uploaded_file($_FILES['aadhaarpic']['tmp_name'], $dir2);
	move_uploaded_file($_FILES['ration_voting']['tmp_name'], $dir3);
	move_uploaded_file($_FILES['birth_school_pan']['tmp_name'], $dir4);
	move_uploaded_file($_FILES['frm16_tax_salary']['tmp_name'], $dir5);

       
        $sql = mysqli_query($con,"insert into tbl_documents(user_id,type,salutation,name,fsalutation,fname,dob,age,gender,occupation,address,street,section,building,landmark,district,taluka,village,pincode,phoneno,panno,aadhaar,email,photo,aadhaarpic,ration_voting,birth_school_pan,frm16_tax_salary,agreement,status,added_on,income,incomeyear,income_words,reason) values('$user_id','$type','$salutation','$name','$fsalutation','$fname','$dob','$age','$gender','$occupation','$address','$street','$section','$building','$landmark','$district','$taluka','$village','$pincode','$phoneno','$panno','$aadhaar','$email','$photo','$aadhaarpic','$ration_voting','$birth_school_pan','$frm16_tax_salary','$agreement','$status','$added_on','$income','$incomeyear','$income_words','$reason')");
	if ($sql==TRUE) {
		$msg5 = "You have successfully applied for Income Certificate.<br>You will get the Income Certificate within 7 day's";
	}
			...
			<div class="container">
				<div class="page-title-content">
					...
					<ul>
						...
						<li class="active">Income Certificate</li>
					</ul>
				</div>
			</div>
		</div>
                    ...
                    <div class="col-lg-8 col-md-6">
						...
						<div class="row">
							<div class="col-3">
								<div class="form-group mt-3">
                                    ...
                                    <input class="form-control" type="text" name="incomeyear" required>
								</div>
							</div>
							...
							<div class="col-3">
								<div class="form-group mt-3">
									...
									<input class="form-control" type="text" name="income" required>
								</div>
							</div>
							<div class="col-3">
								<div class="form-group mt-3">
									<label>Income in Words*</label>
									<input class="form-control" type="text" name="income_words" required>
								</div>
							</div>
							<div class="col-3">
								<div class="form-group mt-3">
                        ...
                        <div class="row">
							...
							<div class="col-4">
								<div class="form-group mt-3">
									<label>PAN No.*</label>
									<input class="form-control" type="text" name="panno" required>
								</div>
							</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
								<div class="form-group mt-3">
                                    ...
                                    <input class="form-control" type="file" name="aadhaarpic" required>
								</div>
							</div>
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Ration Card / Voting Card*</label>
                                    <input class="form-control" type="file" name="ration_voting" required>
								</div>
							</div>
					    </div>
                        <div class="row">
                            ...
                            <div class="col-6">
								<div class="form-group mt-3">
                                    <label>Birth Certificate / School Leaving Certificate / PAN Card*</label>
                                    <input class="form-control" type="file" name="birth_school_pan" required>
								</div>
							</div>
                            <div class="col-6">
								<div class="form-group mt-3">
                                    <label>Form 16 (If you have salary), Income Tax Slip, Salary Slip*</label>
                                    <input class="form-control" type="file" name="frm16_tax_salary" required>
								</div>
							</div>
					    </div>
					</div>
