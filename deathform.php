...
if (isset($_POST['submit'])){
    ...
    $name = get_safe_value($con,$_POST['name']);
    $dod = get_safe_value($con,$_POST['dod']);
	...
	$deathslip = $_FILES['deathslip']['name'];

	$dir1 = "death/".$aadhaarpic;
	$dir2 = "death/".$birth;
	$dir3 = "death/".$ration;
	$dir4 = "death/".$medical;
	$dir5 = "death/".$deathslip;

	move_uploaded_file($_FILES['aadhaarpic']['tmp_name'], $dir1);
	move_uploaded_file($_FILES['birth']['tmp_name'], $dir2);
	move_uploaded_file($_FILES['ration']['tmp_name'], $dir3);
	move_uploaded_file($_FILES['medical']['tmp_name'], $dir4);
	move_uploaded_file($_FILES['deathslip']['tmp_name'], $dir5);

       
        $sql = mysqli_query($con,"insert into tbl_death(user_id,type,salutation,name,dod,gender,address,street,section,building,landmark,district,taluka,village,pincode,aadhaar,aadhaarpic,birth,ration,medical,deathslip,agreement,status,added_on) values('$user_id','$type','$salutation','$name','$dod','$gender','$address','$street','$section','$building','$landmark','$district','$taluka','$village','$pincode','$aadhaar','$aadhaarpic','$birth','$ration','$medical','$deathslip','$agreement','$status','$added_on')");
	if ($sql==TRUE) {
		$msg5 = "You have successfully applied for Death Certificate.<br>You will get the Death Certificate within 7 day's";
	}
				...
				<div class="row">
                    ...
                    <div class="col-lg-8 col-md-6">
						...
						<div class="row">
						    ...
						    <div class="col-9">
								<div class="form-group mt-3">
								    <label>Full Name of Death Person*</label>
                        ...
                        <div class="row">
							<div class="col-4">
								<div class="form-group mt-3">
                                    <label>Aadhaar card of deceased*</label>
                                    <input class="form-control" type="file" name="aadhaarpic" required>
								</div>
							</div>
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Proof of birth of the deceased*</label>
                                    <input class="form-control" type="file" name="birth" required>
								</div>
							</div>
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Copy of the ration card*</label>
                        ...
                        <div class="row">
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Medical Certification of causes of Death*</label>
                                    <input class="form-control" type="file" name="medical" required>
								</div>
							</div>
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Death slip by doctor*</label>
                                    <input class="form-control" type="file" name="deathslip" required>
								</div>
							</div>
