		...
		<section class="certificate">
			<div class="container">
				<div class="certificate-title">
					<h3>Required Documents For Death Certificate</h3>
				</div>
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>1) Proof of birth of the deceased.</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>2) Copy of the ration card.</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>3) Medical Certification of causes of Death.</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>4) Aadhaar card of deceased.</h6>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
                    ...
                    <div class="certificate-button">
                        <?php
                            if($_SESSION['USER_LOGIN']){?>
                                ...
                                <a href="deathform.php" class="default-btn">Next</a>
                            <?php }else{?>
