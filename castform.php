...
if (isset($_POST['submit'])){
    ...
    $email = get_safe_value($con,$_POST['email']);
    $caste = get_safe_value($con,$_POST['caste']);
	...
	$residance = $_FILES['residance']['name'];
	$income = $_FILES['income']['name'];

	$dir1 = "caste/".$photo;
	$dir2 = "caste/".$aadhaarpic;
	$dir3 = "caste/".$ration;
	$dir4 = "caste/".$birth;
	$dir5 = "caste/".$voter;
	$dir6 = "caste/".$residance;
	$dir7 = "caste/".$income;

	move_uploaded_file($_FILES['photo']['tmp_name'], $dir1);
	move_uploaded_file($_FILES['aadhaarpic']['tmp_name'], $dir2);
	move_uploaded_file($_FILES['ration']['tmp_name'], $dir3);
	move_uploaded_file($_FILES['birth']['tmp_name'], $dir4);
	move_uploaded_file($_FILES['voter']['tmp_name'], $dir5);
	move_uploaded_file($_FILES['residance']['tmp_name'], $dir6);
	move_uploaded_file($_FILES['income']['tmp_name'], $dir7);

       
        $sql = mysqli_query($con,"insert into tbl_caste(user_id,type,salutation,name,fsalutation,fname,dob,age,gender,occupation,address,street,section,building,landmark,district,taluka,village,pincode,phoneno,panno,aadhaar,email,photo,aadhaarpic,ration,birth,voter,residance,income,agreement,status,added_on,caste) values('$user_id','$type','$salutation','$name','$fsalutation','$fname','$dob','$age','$gender','$occupation','$address','$street','$section','$building','$landmark','$district','$taluka','$village','$pincode','$phoneno','$panno','$aadhaar','$email','$photo','$aadhaarpic','$ration','$birth','$voter','$residance','$income','$agreement','$status','$added_on','$caste')");
	if ($sql==TRUE) {
		$msg5 = "You have successfully applied for Caste Certificate.<br>You will get the Caste Certificate within 7 day's";
	}
			...
			<div class="container">
				<div class="page-title-content">
					...
					<ul>
						...
						<li class="active">Caste Certificate</li>
					</ul>
				</div>
			</div>
		</div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="row">
							...
							<div class="col-4">
								<div class="form-group mt-3">
                                    <label>Caste*</label>
                                    <input class="form-control" type="text" name="caste" required>
								</div>
							</div>
					    </div>
                        <div class="strip">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Copy of ration card*</label>
                                    <input class="form-control" type="file" name="ration" required>
								</div>
							</div>
					    </div>
                        <div class="row">
                            <div class="col-4">
								<div class="form-group mt-3">
                                    ...
                                    <input class="form-control" type="file" name="birth" required>
								</div>
							</div>
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Copy of voter ID Card*</label>
                                    <input class="form-control" type="file" name="voter" required>
								</div>
							</div>
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Proof of residence*</label>
                                    <input class="form-control" type="file" name="residance" required>
								</div>
							</div>
					    </div>
                        <div class="row">
                            <div class="col-4">
								<div class="form-group mt-3">
                                    <label>Copy of income certificate*</label>
                                    <input class="form-control" type="file" name="income" required>
								</div>
							</div>
					    </div>
					</div>
