		...
		<section class="certificate">
			<div class="container">
				<div class="certificate-title">
					<h3>Required Documents For Caste Certificate</h3>
				</div>
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>1) Proof of residence</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>2) Copy of birth certificate</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>4) Copy of income certificate</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="certificate-button">
                        <?php
                            if($_SESSION['USER_LOGIN']){?>
                                ...
                                <a href="castform.php" class="default-btn">Next</a>
                            <?php }else{?>
