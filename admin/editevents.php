...
$view=mysqli_query($con, "select * from tbl_events where id='".$_GET['id']."' ");

if (isset($_POST['submit'])) {
    $title = get_safe_value($con,$_POST['title']);
    $edate = get_safe_value($con,$_POST['edate']);
...
// prx($_POST);die();
    ...
    $sql = mysqli_query($con,"UPDATE tbl_events set title='$title',edate='$edate', puser='$puser', shortdesc='$shortdesc', longdesc='$longdesc', images='$images' WHERE id='".$_GET['id']."'");
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="Email" placeholder="Event Date" name="edate" value="<?php echo $row['edate']?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
