...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con,"INSERT INTO tbl_events(title,edate,puser,images,shortdesc,longdesc) VALUES('$title','$edate','$puser','$images','$shortdesc','$longdesc')");
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Email" placeholder="Event Title" name="title">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="Email" placeholder="Event Date" name="edate">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
