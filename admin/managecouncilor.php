...
if (isset($_GET['type']) && $_GET['type']!='') {
    ...
    if ($type=='delete') {
        ...
        $delete_sql = "DELETE FROM tbl_councilor WHERE id = '$id'";
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Manage Councilor</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        <td><img src="../employee/<?php echo $row['images']?>" width="200px" height="100px"></td>
                                        ...
                                        <td>
                                             <?php 
                                                ...
                                                echo "<a href='editcouncilor.php?id=".$row['id']."' style='color:green;font-weight:bold;font-size:18px;'><i class='fas fa-edit'></i></a>&nbsp;&nbsp;&nbsp;";
