...
if (isset($_GET['type']) && $_GET['type']!='') {
    ...
    if ($type=='delete') {
        ...
        $delete_sql = "DELETE FROM tbl_death WHERE id = '$id'";
        mysqli_query($con,$delete_sql);
    }
}

$sql = "SELECT * FROM tbl_death order by id desc";
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td><a href="deathdetails.php?id=<?php echo $row['id']?>" class="btn btn-success"><?php echo $row['id']?></td>
