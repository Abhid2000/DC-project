...
if (isset($_POST['submit'])){
    ...
    $name = get_safe_value($con,$_POST['name']);
    $doc = get_safe_value($con,$_POST['doc']);
    ...
    $laddress = get_safe_value($con,$_POST['laddress']);
    $pdesc = get_safe_value($con,$_POST['pdesc']);
	...
	$dir1 = "complaint/".$lphoto;

	move_uploaded_file($_FILES['lphoto']['tmp_name'], $dir1);

       
        $sql = mysqli_query($con,"insert into tbl_complaint(user_id,salutation,name,doc,gender,address,street,section,building,landmark,district,taluka,village,pincode,laddress,pdesc,lphoto,agreement,status,added_on) values('$user_id','$salutation','$name','$doc','$gender','$address','$street','$section','$building','$landmark','$district','$taluka','$village','$pincode','$laddress','$pdesc','$lphoto','$agreement','$status','$added_on')");
	if ($sql==TRUE) {
		$msg5 = "Your complaint registration is successfully done.<br>You will get the result within 7 to 10 day's";
	}
			...
			<div class="container-fluid">
				<div class="row">
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
								<div class="form-group mt-3">
                                    ...
                                    <input class="form-control" type="date" name="doc" required>
								</div>
							</div>
					    </div>
                        <div class="strip">
                            <h5>2. Applicant's Address</h5>
                        </div>
                        <div class="row">
							<div class="col-6">
								<div class="form-group mt-3">
                        ...
                        <div class="strip">
                            <h5>3. Complaint Details</h5>
                        </div>
                        <div class="row">
                            <div class="col-12">
								<div class="form-group mt-3">
									<label>Full Address of Location*</label>
									<input class="form-control" type="text" name="laddress" required>
								</div>
							</div>
                            <div class="col-12">
								<div class="form-group mt-3">
									<label>Problem Description*</label>
									<textarea class="form-control" name="pdesc" rows="7" required></textarea>
								</div>
							</div>
					    </div>
                        <div class="strip">
                        ...
                        <div class="row">
							<div class="col-4">
								<div class="form-group mt-3">
                                    <label>Location Photo For Verification*</label>
                                    <input class="form-control" type="file" name="lphoto" required>
								</div>
							</div>
