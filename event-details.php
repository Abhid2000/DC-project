...
$view=mysqli_query($con, "select * from tbl_events where id='$event_id' ");
$view1=mysqli_query($con, "select * from tbl_events where id='$event_id' ");
			...
			<div class="container">
				<div class="project-details-content">
					<div class="services-content">
						<img src="events/<?php echo $row['images']?>" alt="Image">
					</div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="eventcontent">
                                    <p><i class="ri-user-line"></i>  <?php echo $row['puser']?></p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="eventcontent">
                                    <p><i class="ri-calendar-line"></i> <?php echo $row['edate']?></p>
                                </div>
                                </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="eventcontent">
