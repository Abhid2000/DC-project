		...
		<section class="certificate">
			<div class="container">
				<div class="certificate-title">
					<h3>Required Documents For Birth Certificate</h3>
				</div>
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>1) Proof of identity of the parent for verification</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>2) Parental marriage certificate</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>3) Letter from the hospital - Proof of birth</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>4) Parent's birth certificate or SSC mark sheet</h6>
							</div>
						</div>
					</div>
                    ...
                    <div class="certificate-button">
                        <?php
                            if($_SESSION['USER_LOGIN']){?>
                                ...
                                <a href="birthform.php" class="default-btn">Next</a>
                            <?php }else{?>
