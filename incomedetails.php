            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <?php 
                        ...
                        $sql = "SELECT * FROM tbl_documents WHERE user_id='$user_id' order by id desc";
                    ...
                    <tr class="text-center">
                        ...
                        <?php 
                            if ($row['status']=='Done') {?>
                                <td><a href="incomeprint.php?id=<?php echo $row['id']?>" class="btn btn-success" >Print Income</a></td>
                         <?php  }else{?>
                                <td>Under Process</td>
                    </tr>
                    <?php } }?>
