...
$view=mysqli_query($con, "select * from tbl_news where id='$news_id' ");
$view1=mysqli_query($con, "select * from tbl_news where id='$news_id' ");
			...
			<div class="container">
				<div class="project-details-content">
					<div class="services-content">
						<img src="news/<?php echo $row['images']?>" alt="Image">
					</div>
					...
					<div class="services-content">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="eventcontent">
                                    <p><i class="ri-calendar-line"></i> <?php echo $row['ndate']?></p>
                                </div>
                            </div>
                        </div>
