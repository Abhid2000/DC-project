		...
		<section class="certificate">
			<div class="container">
				<div class="certificate-title">
					<h3>Required Documents For Income Certificate</h3>
				</div>
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>1) Birth Certificate / School Leaving Certificate / PAN Card</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>2) Ration Card / Driving License / Voting Card</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>4) Aadhaar Card / Driving License / Voting Card</h6>
							</div>
						</div>
					</div>
                    <div class="col-lg-3 col-md-6">
						<div class="certificate-project">
							<div class="certificate-content">
							<h6>5) Form 16 (If you have salary), Income Tax Slip, Salary Slip</h6>
							</div>
						</div>
					</div>
				</div>
                    ...
                    <div class="certificate-button">
                        <?php
                            if($_SESSION['USER_LOGIN']){?>
                                ...
                                <a href="incomeform.php" class="default-btn">Next</a>
                            <?php }else{?>
                                <a href="#" class="default-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Next</a>
                            <?php }?>
                    </div>
                </div>
			</div>
